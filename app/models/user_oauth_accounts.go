...
type UserOauthAccount struct {
	...
	AccountID    string    `gorm:"column:account_id;not null;index"                                                  json:"account_id"`
	AccountName  string    `gorm:"column:account_name;index"                                                         json:"account_name"`
	AccountEmail string    `gorm:"column:account_email;not null;index"                                               json:"account_email"`
}
