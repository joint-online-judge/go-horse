...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Gravatar = field.NewString(tableName, "gravatar")
	...
	_user.UsernameLower = field.NewString(tableName, "username_lower")
	_user.EmailLower = field.NewString(tableName, "email_lower")
...
type user struct {
	...
	UsernameLower  field.String
	EmailLower     field.String
...
func (u *user) updateTableName(table string) *user {
	...
	u.Gravatar = field.NewString(table, "gravatar")
	...
	u.UsernameLower = field.NewString(table, "username_lower")
	u.EmailLower = field.NewString(table, "email_lower")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["gravatar"] = u.Gravatar
	...
	u.fieldMap["username_lower"] = u.UsernameLower
	u.fieldMap["email_lower"] = u.EmailLower
